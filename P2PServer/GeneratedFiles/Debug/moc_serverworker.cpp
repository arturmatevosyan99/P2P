...
void ServerWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ServerWorker::*)(QJsonObject const & );
        ...
        {
            using _t = void (ServerWorker::*)(QString const & );
...
// SIGNAL 0
void ServerWorker::jsonReceived(QJsonObject const & _t1)
{
...
// SIGNAL 3
void ServerWorker::logMessage(QString const & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
